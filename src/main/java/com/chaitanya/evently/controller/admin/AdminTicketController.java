...
public class AdminTicketController {
    ...
    public ResponseEntity<Map<String, Object>> getTickets(
        ...
        log.info("Admin requested tickets - pagination: page={}, size={}",
                paginationRequest.getPage(), paginationRequest.getSize());

        String baseUrl = request.getRequestURL().toString();
        PaginationResponse<Ticket> tickets = ticketService.getAllTickets(paginationRequest, baseUrl);
    ...
    public ResponseEntity<Map<String, Object>> getTicketsByBookingId(
        ...
        log.info("Admin requested tickets for bookingId: {} - pagination: page={}, size={}",
